  ...
  inputSchema: {
    ...
    properties: {
      ...
      condicionIvaReceptor: {
        ...
        description:
          'Condición frente al IVA del receptor (RG 5616, obligatorio). 1=IVA Responsable Inscripto, 4=IVA Sujeto Exento, 5=Consumidor Final, 6=Responsable Monotributo, 7=Sujeto No Categorizado, 8=Proveedor del Exterior, 9=Cliente del Exterior, 10=IVA Liberado Ley 19.640, 13=Monotributista Social, 15=IVA No Alcanzado, 16=Monotributo Trabajador Independiente Promovido.',
      },
      fechaComprobante: {
        type: 'string',
